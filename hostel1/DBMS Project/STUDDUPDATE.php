        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="blank.html"><i class="fa fa-edit "></i>Student Registeration</a>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i>User Acces Logs</a>
                    </li>
                            ...
                            <tr>
                                ...
                                (10 Digits Allowed)
                                                ...
                                                <tr>
                                                    ...
                                                    <td><textarea name="Address"  value = " <?php echo $row->Address;?>"rows="10" cols="50"></textarea></td>
                                                    </tr>

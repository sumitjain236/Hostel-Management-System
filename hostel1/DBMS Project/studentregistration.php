...
if(isset($_POST['submit'])){
	...
	$query="INSERT INTO studentregistration(FirstName,LastName,EmailID,MobileNumber,Gender,Birthday,Address,City,PinCode,
							State,Country,Room,Sharing,Mess,Fees_Paid,GuardianName,GMobileNumber,EMobileNumber)
							values('$FirstName','$LastName','$EmailID','$MobileNumber','$Gender','$Birthday','$Address','$City','$PinCode','$State',
							'$Country','$Room','$Sharing','$Mess','$Fees_Paid','$GuardianName','$GMobileNumber','$EMobileNumber')";
                ...
                <div class="row">
                    <div class="col-lg-12 ">
                        <div class="alert alert-info">
                             <strong>Admin Controlled Student Registeration Page</strong>  !
                        </div>
                    </div>
                    </div>

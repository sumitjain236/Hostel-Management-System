    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-lg-12">
                     <h2>Students Permissions Request</h2>   
                    </div>
                </div>    
...
$ret="select * from permissions where status='NA'";
...
<td>
<a href = 'approve.php?rn= "<?php echo $row->id; ?>"'>Approve</a> 
/ <a href = 'decline.php?rn= "<?php echo $row->id; ?>"'>Decline</a></td>
										</tr>
									<?php
$cnt=$cnt+1;
									 } ?>
